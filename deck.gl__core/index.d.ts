//typings for @deck.gl/core v8.0.12
...
declare module '@deck.gl/core/passes/layers-pass' {
	...
	export default class LayersPass extends Pass {
	    ...
	    _drawLayersInViewport(gl: any, { layers, layerFilter, viewport, view, pass, effects, moduleParameters }: {
	        layers: any;
	        layerFilter: any;
	        viewport: any;
	        view: any;
...
declare module '@deck.gl/core/lib/layer-manager' {
	export default class LayerManager {
	    ...
	    _updateSublayersRecursively(newLayers: any, oldLayerMap: any, generatedLayers: any): any;
...
declare module '@deck.gl/core/passes/pick-layers-pass' {
	...
	export default class PickLayersPass extends LayersPass {
	    ...
	    _drawPickingBuffer({ layers, layerFilter, viewports, onViewportActive, pickingFBO, deviceRect: { x, y, width, height }, pass, redrawReason, pickZ }: {
	        layers: any;
	        layerFilter: any;
	        viewports: any;
	        onViewportActive: any;
...
declare module '@deck.gl/core/lib/picking/pick-info' {
	export function processPickInfo({ pickInfo, lastPickedInfo, mode, layers, viewports, x, y, z, pixelRatio }: {
	    pickInfo: any;
	    lastPickedInfo: any;
	    mode: any;
	    layers: any;
	...
	export function callLayerPickingCallbacks(infos: any, mode: any, event: any): any[];
...
declare module '@deck.gl/core/lib/deck-picker' {
	export default class DeckPicker {
	    ...
	    _resizeBuffer(): any;
	    _pickClosestObject({ layers, viewports, x, y, radius, depth, mode, event, unproject3D, onViewportActive }: {
	        layers: any;
	        viewports: any;
	        x: any;
	        y: any;
	    ...
	    _pickVisibleObjects({ layers, viewports, x, y, width, height, mode, onViewportActive }: {
	        layers: any;
	        viewports: any;
	        x: any;
	        y: any;
...
declare module '@deck.gl/core' {
	...
	export { fillArray as _fillArray } from '@deck.gl/core/utils/flatten';
