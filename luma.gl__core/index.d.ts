//typings for @luma.gl/core v8.0.3
declare module '@luma.gl/core' {
	...
	export { AnimationLoop, Model, Transform, ProgramManager, Timeline, Geometry, ClipSpace, ConeGeometry, CubeGeometry, CylinderGeometry, IcoSphereGeometry, PlaneGeometry, SphereGeometry, TruncatedConeGeometry } from '@luma.gl/core/@luma.gl/engine';
	export { normalizeShaderModule, fp32, fp64, project, dirlight, picking, gouraudLighting, phongLighting, pbr } from '@luma.gl/core/@luma.gl/shadertools';
