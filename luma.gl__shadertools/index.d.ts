//typings for @luma.gl/shadertools v8.0.3
...
declare module '@luma.gl/shadertools/lib/shader-module' {
	export default class ShaderModule {
	    constructor({ name, vs, fs, dependencies, uniforms, getUniforms, deprecations, defines, inject, vertexShader, fragmentShader }: {
	        name: any;
	        vs: any;
	        fs: any;
	        dependencies?: any[];
...
declare module '@luma.gl/shadertools/lib/resolve-modules' {
	export function resolveModules(modules: any): any[]; function getShaderDependencies(modules: any): any[]; function getDependencyGraph({ modules, level, moduleMap, moduleDepth }: {
	    modules: any;
	    level: any;
	    moduleMap: any;
	    moduleDepth: any;
...
declare module 'modules' {
	...
	export { default as fp64, fp64arithmetic } from '@luma.gl/shadertools/modules/fp64/fp64';
